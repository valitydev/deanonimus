...
public class ShopConverter {
    ...
    public Map<String, Shop> convert(List<Shop> shops) {
    ...
    private Map.Entry<String, Shop> convertToEntity(Shop shopDomain) {
        return Map.entry(shopDomain.getId(), convertShop(shopDomain));
    }

    private Shop convertShop(Shop shopDomain) {
        Shop shop = new Shop()
    ...
    private void setAccount(Shop shopDomain, Shop shop) {
