...
public class ContractConverter {
    ...
    public Map<String, Contract> convert(List<Contract> contracts) {
    ...
    private Map.Entry<String, Contract> convertToEntity(Contract contract) {
        return Map.entry(contract.getId(), convertContract(contract));
    }

    private Contract convertContract(Contract contractDomain) {
    ...
    private ContractStatus convertStatus(ContractStatus status) {
