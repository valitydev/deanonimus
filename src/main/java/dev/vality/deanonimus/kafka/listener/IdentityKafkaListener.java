...
import dev.vality.deanonimus.kafka.handler.IdentityHandlerService;
...
public class IdentityKafkaListener {
    ...
    private final IdentityHandlerService identityHandlerService;
    ...
    public void handle(List<ConsumerRecord<String, SinkEvent>> messages, Acknowledgment ack) {
        ...
        identityHandlerService.handleEvents(messages.stream()
