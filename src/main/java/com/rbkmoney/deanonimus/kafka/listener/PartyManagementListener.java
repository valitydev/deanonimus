package com.rbkmoney.deanonimus.kafka.listener;

import com.rbkmoney.deanonimus.kafka.handler.PartyManagementHandlerService;
...
public class PartyManagementListener {
    ...
    private final PartyManagementHandlerService partyManagementHandlerService;
    ...
    public void handle(List<ConsumerRecord<String, SinkEvent>> messages, Acknowledgment ack) {
        ...
        partyManagementHandlerService.handleEvents(
                messages.stream()
